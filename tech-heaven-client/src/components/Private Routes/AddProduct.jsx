...
const AddProduct = () => {
  ...
  const handleDB = (e) => {
    ...
    setToastMessage("Adding Product is disabled by Admin");
    setToastType("error");
    setShowToast(true);
    setTimeout(() => {
      setShowToast(false);
      ...
      <div>
        ...
        >
          <div className="w-10/12 m-auto md:pt-3">
            ...
            <h2 className="md:text-base text-sm bg-red-500 inline-block px-6 py-2 rounded-md">Adding new product is disabled due to security reason</h2>
